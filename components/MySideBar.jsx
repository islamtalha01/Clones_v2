...
const MySideBar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed p-4 h-screen inset-y-0 left-0 z-30 w-[250px] border border-[#292932] overflow-y-auto transition duration-300 transform bg-[#1C1C24] lg:translate-x-0 lg:static lg:inset-0 ${
      ...
      >
        <nav className="flex flex-col h-full justify-between">
          ...
          <div ref={dropdownRef} className=" mb-36">
            <button
